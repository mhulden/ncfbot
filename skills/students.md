...
| Course-load tuition billing bands, full-time status, aid consequences of dropping or withdrawing, Title IV and Bright Futures repayment, refunds, payment deadlines, SAP, VA benefits and the SCO, F-1 cautions, holds that block enrollment or graduation | `resources/students/financial-and-status-cautions.md` (`students-financial-and-status-cautions`) |
